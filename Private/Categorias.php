...
<body>
  ...
  <div id="oculto"> 
          <p>&nbsp;</p>
          <div id="id">
            <p class="tit" align="center" id="ptit">&quot;Registro Categoria&quot;</p>
          </div>
          <p>&nbsp; </p>
          <form id="frmregiscate" name="frmregiscate" method="POST" action="">
            ...
            <table width="351" border="0" align="center">
              <tr>
                <td width="130" align="right" valign="middle" class="prf">ID:</td>
                <td width="211" align="left" valign="middle">
                <input name="txt_curp" type="text" class="txt_text" id="txt_ID" maxlength="10" placeholder="clave" required/></td>
              </tr>
              <tr>
                <td align="right" valign="middle" class="prf">Categoria:</td>
                <td align="left" valign="middle">
                <input name="txt_nombre" type="text" class="txt_text" id="txt_nombre_ca" maxlength="30" placeholder="Categoria" required/>
              ...
              <tr>
                ...
                <td align="left" valign="middle"><input name="btn_guardar" type="submit" class="btn" id="btn_salir" value="SALIR" /></td>
              </tr>
            </table>
            <p>
              </p>
	...
	<div id="contened">
		...
		<section>
			<div id="templatemo_content_right"> 
         		<p>&nbsp;</p>
         		<div id="id">
          		<p class="tit">&quot;Registro de Categorias&quot;</p>
          		</div>
          		<p>&nbsp; </p>
                ...
                <input name="txt_nombre" type="hidden" class="txt_text" id="txtopcion" maxlength="30" value="insertar" placeholder="Categoria" required/>
            		...
            		<p>&nbsp;</p>
            		<div id="divcuerpo">
            			<table width="700" border="1" align="center" class="tbl1" id="tbl_contenido">
              				<tr>
                      ...
                      <?php
                        ...
                        $con=new Conexion();
                        $consul=$con->consulta("SELECT * FROM tbl_categorias");
                        while ($fila=mysql_fetch_array($consul)) {
                          $cat=utf8_encode($fila[1]);
                          echo ("<tr>
                            <td>".$fila[0]."</td><td>".$cat."</td><td><input type='radio' name='rbd_cat' value=".$fila[0]."></td>
                            </tr>");
                        }
                      ?>
            			</table>
