$(document).ready(function(){
	...
	$('#btn_guardar_ca').click(function(){
        ...
        var accion ="insertar";
        if(id=="" || rcf==""|| nombre==""|| ap==""|| am==""||dire==""||tel==""||email==""||user==""){
            ...
            alert("Su cuenta a sido creado. Para logear debe ingresar el usuario y contraseña que creo.!");
        }
	});
    ...
    $('#btn_modificar').click(function(){
        ...
        {
            alert('Para poder eliminar un cliente debes de seleccionar un registro');
        }
