			...
			<div class="cont">
				...
				<div id="login">
					 <form id="form11" name="form1" method="post"  action="./php/verificalogin.php">
          				     <center>¿Quien es somos?</center><br>
          				      Sexshop.com  pertenece a "Aquila Emporium Group S.A. DE C.V." empresa dedicada a múltiples negocios, incluyendo la importación y comercialización de productos de gran calidad para Adultos.<br>

								Nuestras oficinas y sala de exhibición-venta directa al público, se encuentran en la Ciudad de huejutla de reyes hidalgo en Avenida Insurgentes Sur 105 Piso 16 Interior 1603, Colonia Juárez Delegación Cuauhtemoc C.P.06600<br><br>

								Objetivo:<br>
								Ofrecer productos novedosos y de gran calidad, para mejorar, o bien satisfacer la sexualidad de cada persona.<br><br>

								Misión:<br>

								Proveer a nuestros clientes, en tiempo y con plena satisfacción, cada uno de nuestros productos.<br><br>

								Visión:<br>

								Ser Una empresa que se destaque por la calidad de sus productos y servicios.
       	 			 </form>
       		 	</div>
       		</div>
		</section>
